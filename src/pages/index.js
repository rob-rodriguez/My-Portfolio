      ...
      <div className={styles.recentProjects}>
        ...
        <div className={`${styles.project} container`}>
          <div className={styles.projectText}>
            <h3>Project Title</h3>
            <p>Lorem Officia tempor commodo ex deserunt proident. Adipisicing ullamco velit qui sit et nostrud ea. Ipsum Lorem sunt id excepteur laboris. Sunt minim minim ullamco ad ad.</p>
            <a href="#" className="button primary">View Project</a>
          </div>
          <motion.div style={{ y: scrollYProgress }}>
            <StaticImage src="../images/laptop-image.png" alt="" placeholder="blurred" quality={80} className={styles.projectImage} />
          </motion.div>
        </div>
